...
export function Services() {
    ...
    return (
        <Section id="expertise" className="bg-graphite/30 perspective-1000 relative" ref={containerRef}>
            <FloatingShapes />
            <div className="services-header mb-16 text-center opacity-0 relative z-10">
                                ...
                                <div className="p-8 h-full bg-graphite/40 flex flex-col">
                                    ...
                                    <div className="relative z-10 flex flex-col h-full">
                                        <div className="flex items-center justify-between mb-6">
                                            <div className="w-12 h-12 rounded-lg bg-black/50 flex items-center justify-center group-hover:bg-premium-purple text-premium-purple group-hover:text-white transition-colors duration-300">
                                                <Icon className="w-6 h-6" />
                                            </div>
                                            {service.category && (
                                                <span className="text-[10px] uppercase tracking-wider font-bold text-premium-cyan/80 border border-premium-cyan/30 rounded-full px-2 py-1">
                                                    {service.category}
                                                </span>
                                            )}
                                        </div>
                                        ...
                                        {service.price && (
                                            <div className="pt-4 border-t border-white/10 text-sm font-semibold text-white">
                                                {service.price}
                                            </div>
                                        )}
                                    </div>
