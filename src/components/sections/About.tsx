...
export function About() {
    ...
    return (
        <Section id="about" className="bg-graphite/30 relative" ref={containerRef}>
                                ...
                                <div className="bg-white/5 border border-white/10 p-6 rounded-xl hover:bg-white/10 transition-colors backdrop-blur-sm cursor-default">
                                    ...
                                    {item.year === "2024" ? (
                                        <h4 className="text-xl font-bold text-white mb-2">
                                            <GlitchText
                                                text="Dev Full Stack Sênior"
                                                options={[
                                                    { text: "Dev Full Stack Sênior", className: "text-white" },
                                                    { text: "Junior", className: "text-gray-400" },
                                                    { text: "Pleno", className: "text-gray-300" },
                                                    { text: "Senior", className: "text-white" },
                                                    { text: "???", className: "text-red-400" },
                                                    { text: "Unknown", className: "text-red-500 font-bold" },
                                                    { text: "CRITICAL FAILURE", className: "text-red-600 font-bold" }
                                                ]}
                                                className=""
                                                speed={40}
                                                cycleSpeed={2000}
